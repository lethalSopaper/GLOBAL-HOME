...
insert into MENSAJE (mensaje_id, titulo, cuerpo, leido, fecha_envio, usuario_id, vivienda_id) values (mensaje_seq.nextval, 'titulo-1-vivienda_id-1', 'cuerpo_mensaje-1-vivienda_id-1', true, to_date('29-02-2023','dd-mm-yyyy'), 41, 1);
...
insert into MENSAJE (mensaje_id, titulo, cuerpo, leido, fecha_envio, usuario_id, vivienda_id) values (mensaje_seq.nextval, 'titulo-1-vivienda_id-7', 'cuerpo_mensaje-1-vivienda_id-7', false, to_date('30-02-2023','dd-mm-yyyy'), 47, 2);
...
insert into MENSAJE (mensaje_id, titulo, cuerpo, leido, fecha_envio, usuario_id, vivienda_id) values (mensaje_seq.nextval, 'titulo-1-vivienda_id-9', 'cuerpo_mensaje-1-vivienda_id-9', false, to_date('29-02-2023','dd-mm-yyyy'), 49, 4);
...
insert into MENSAJE (mensaje_id, titulo, cuerpo, leido, fecha_envio, usuario_id, vivienda_id) values (mensaje_seq.nxtval, 'titulo-2-vivienda_id-12', 'cuerpo_mensaje-2-vivienda_id-12', true, to_date('12-04-2023','dd-mm-yyyy'), 5, 7);
...
insert into MENSAJE (mensaje_id, titulo, cuerpo, leido, fecha_envio, usuario_id, vivienda_id, mensaje_respuesta_id) values (mensaje_seq.nextval, 'titulo-2-vivienda_id-20', 'cuerpo_mensaje-2-vivienda_id-15', true, to_date('23-051-2023','dd-mm-yyyy'), 30, 20, 25);
-- Mensajes:
